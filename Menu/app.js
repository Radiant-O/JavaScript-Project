 ...
 const filterBtn = containerBtn.querySelectorAll('.filter-btn')
  ...
  filterBtn.forEach(function(btn){
    btn.addEventListener('click', function(e){
      ...
      if(menuItem.category === filterCategory){
        return menuItem
      }
      })
...
const oldArray = [ 'ola', 'radiant', 'solodev']

const editArray = oldArray.map((e) => e + ' is a Developer')

console.log(editArray)

// const givenArray = [1, 2,  3, 4, 5];
// const sim = givenArray.reduce ((acc,  curr) => acc + curr) 
